...
!(function (e) {
  ...
  "function" == typeof window.matchMedia
    ? (e(window).on("resize kingster-set-display", function () {
        ...
        "function" == typeof e.fn.superfish &&
          ...
          e(window).resize(
            ...
            function () {
              var e = this,
                a = arguments;
              s ? clearTimeout(s) : n && t.apply(e, a),
    ...
    sf_menu_position: function () {
      if ("mobile-landscape" != t && "mobile-portrait" != t && "tablet" != t) {
        var i = e(".kingster-body-wrapper"),
          n = this.main_menu.find(
            ".sf-menu > li.kingster-normal-menu .sub-menu"
          );
        n.css({ display: "block" }).removeClass("sub-menu-right"),
          n.each(function () {
            e(this).offset().left + e(this).width() > i.outerWidth() &&
              e(this).addClass("sub-menu-right");
          }),
          n.css({ display: "none" }),
          this.main_menu
            .find(".sf-menu > li.kingster-mega-menu .sf-mega")
            .each(function () {
    ...
    (e.fn.kingster_mobile_menu = function (t) {
      ...
      if (
        (e(this)
          ...
          .each(function () {
            var t = e(this).html();
            e('<span class="kingster-mm-menu-blank" ></span>')
              .html(t)
              .insertBefore(e(this)),
              e(this).remove();
          }),
  ...
  var n = function (e) {
    (this.menu = e),
      (this.menu_button = e.children(".kingster-overlay-menu-icon")),
      (this.menu_content = e.children(".kingster-overlay-menu-content")),
      (this.menu_close = this.menu_content.children(
        ".kingster-overlay-menu-close"
      )),
      this.init();
  };
  n.prototype = {
          ...
          if (n.length > 0) {
            if (!n.hasClass("kingster-active")) {
              var s = n
                .closest("li")
                .siblings()
                .find(".sub-menu.kingster-active");
              return (
                s.length > 0
                  ? (s.removeClass("kingster-active").slideUp(150),
                    n
                      .delay(150)
                      .slideDown(400, "easeOutQuart")
                      .addClass("kingster-active"))
                  : n
                      .slideDown(400, "easeOutQuart")
                      .addClass("kingster-active"),
                e(this).addClass("kingster-no-preload"),
                !1
              );
            }
      ...
      i.init_nav_bar_element(),
        ...
        e(window).scroll(function () {
          if (
            ...
            "mobile-portrait" != t &&
            "tablet" != t &&
            i.side_nav.hasClass("kingster-allow-slide")
          ) {
            var n = parseInt(e("html").css("margin-top")),
              s = e(window).scrollTop() > i.prev_scroll;
            if (((i.prev_scroll = e(window).scrollTop()), s))
              i.side_nav.hasClass("kingster-fix-bottom") ||
                (i.side_nav.hasClass("kingster-fix-top")
                  ? (i.side_nav.css("top", i.side_nav.offset().top),
                    i.side_nav.removeClass("kingster-fix-top"))
                  : e(window).height() + e(window).scrollTop() >
                      i.side_nav_content.offset().top +
                        i.side_nav_content.outerHeight() &&
                    (i.side_nav.hasClass("kingster-fix-bottom") ||
                      (i.side_nav.addClass("kingster-fix-bottom"),
                      i.side_nav.css("top", ""))));
              ...
              if (i.side_nav.hasClass("kingster-fix-bottom")) {
                var a =
                  ...
                  (e(window).height() - n) -
                  i.side_nav_content.outerHeight();
                i.side_nav.css("top", a),
                  i.side_nav.removeClass("kingster-fix-bottom");
              } else
                e(window).scrollTop() + n < i.side_nav_content.offset().top &&
                  (i.side_nav.hasClass("kingster-fix-top") ||
                    (i.side_nav.addClass("kingster-fix-top"),
                    i.side_nav.css("top", "")));
          }
        });
    },
      ...
      if ("mobile-landscape" != t && "mobile-portrait" != t && "tablet" != t) {
        var i = this,
          n = i.side_nav_content
            .children(".kingster-pos-middle")
            .addClass("kingster-active"),
          s = i.side_nav_content
            .children(".kingster-pos-bottom")
            .addClass("kingster-active");
        i.side_nav_content.children(".kingster-pre-spaces").remove(),
          e(window).height() < i.side_nav_content.height()
            ? i.side_nav.addClass("kingster-allow-slide")
            : (i.side_nav
                .removeClass(
                  "kingster-allow-slide kingster-fix-top kingster-fix-bottom"
                )
                .css("top", ""),
              i.side_nav.hasClass("kingster-style-middle") &&
                n.each(function () {
                  var t = parseInt(e(this).css("padding-top")),
                    n =
                      ...
                      t;
                  n > 0 &&
                    e('<div class="kingster-pre-spaces" ></div>')
                      .css("height", n)
                      .insertBefore(e(this));
                }),
              s.each(function () {
  ...
  var a = function () {
    (this.anchor_link = e('a[href*="#"]')
      ...
      .filter(function () {
        return (
          !e(this).is(
            ".kingster-mm-menu-button, .mm-next, .mm-prev, .mm-title, .gdlr-core-ilightbox"
          ) &&
          !e(this).is(".fbx-btn-transition") &&
          !e(this).parent(".description_tab, .reviews_tab").length &&
          !e(this).not('[class^="kingster"]').closest(".woocommerce").length
        );
      })),
      this.anchor_link.length &&
        ((this.menu_anchor = e("#kingster-main-menu, #kingster-bullet-anchor")),
        (this.home_anchor = this.menu_anchor.find(
          "ul.sf-menu > li.current-menu-item > a, ul.sf-menu > li.current-menu-ancestor > a, .kingster-bullet-anchor-link.current-menu-item"
        )),
        this.init());
  };
  a.prototype = {
      ...
      return void 0 !== a
        ? ((a -= parseInt(e("html").css("margin-top"))),
          "mobile-portrait" == t || "mobile-landscape" == t
            ? (a -= 75)
            : void 0 !== window.kingster_anchor_offset &&
              (a -= parseInt(window.kingster_anchor_offset)),
          a < 0 && (a = 0),
          e("html, body").animate(
            { scrollTop: a },
          ...
          !1)
        : n
        ? ((window.location.href = kingster_script_core.home_url + i), !1)
        : void 0;
    },
    scroll_section: function () {
      ...
      if (n.length) {
        ...
        a.length &&
          (n.each(function () {
            0 == e(this).closest(".sub-menu").length &&
              e(this.hash).length &&
              e(this).attr("data-anchor", this.hash);
          }),
          e(window).scroll(function () {
            if (
              "mobile-landscape" != t &&
              ...
              if (
                ...
                e(window).scrollTop() <= s.offset().top
              )
                i.home_anchor.each(function () {
                  e(this).hasClass("kingster-bullet-anchor-link")
                    ? (e(this)
                        .addClass("current-menu-item")
                        .siblings()
                        .removeClass("current-menu-item"),
                      e(this)
                        .parent(".kingster-bullet-anchor")
                        .attr("data-anchor-section", "kingster-home"))
                    : e(this).parent(
                          ...
                          .each(function () {
                            e(this).hasClass("kingster-bullet-anchor-link")
                              ...
                              : e(this).parent("li.menu-item").length &&
                                ...
                                e(window).trigger(
                                  "kingster-navigation-slider-bar-init"
                                ));
                          }),
                        !1
                      );
  ...
  var o = function () {
    var t = this;
    (t.sticky_nav = e(
      ".kingster-with-sticky-navigation .kingster-sticky-navigation"
    )),
      (t.mobile_menu = e("#kingster-mobile-header")),
      t.sticky_nav.hasClass("kingster-sticky-navigation-height")
        ? ((window.kingster_anchor_offset = t.sticky_nav.outerHeight()),
          e(window).resize(function () {
            window.kingster_anchor_offset = t.sticky_nav.outerHeight();
          }))
        : t.sticky_nav.attr("data-navigation-offset")
        ? (window.kingster_anchor_offset = parseInt(
            t.sticky_nav.attr("data-navigation-offset")
          ))
        : t.sticky_nav.length && (window.kingster_anchor_offset = 75),
      t.sticky_nav.length && t.init(),
      t.mobile_menu.hasClass("kingster-sticky-mobile-navigation") &&
        (t.style_mobile_slide(),
        e(window).trigger("kingster-set-sticky-mobile-navigation"));
  };
  o.prototype = {
    init: function () {
      this.sticky_nav.hasClass("kingster-style-fixed")
        ? this.style_fixed()
        : this.sticky_nav.hasClass("kingster-style-slide") &&
          this.style_slide(),
        e(window).trigger("kingster-set-sticky-navigation");
    },
    style_fixed: function () {
      ...
      e(window).on("scroll kingster-set-sticky-navigation", function () {
        if (
          ...
          i.sticky_nav.hasClass("kingster-fixed-navigation")
            ? e(window).scrollTop() + s <= n.offset().top &&
              (i.sticky_nav.hasClass("kingster-without-placeholder") ||
                i.sticky_nav.height(n.height()),
              i.sticky_nav.insertBefore(n),
              i.sticky_nav.removeClass("kingster-fixed-navigation"),
              n.remove(),
              setTimeout(function () {
              ...
              setTimeout(function () {
                i.sticky_nav.css("height", ""),
                  e(window).trigger("kingster-navigation-slider-bar-animate");
              }, 200))
            : e(window).scrollTop() + s > i.sticky_nav.offset().top &&
              (i.sticky_nav.hasClass("kingster-without-placeholder") ||
                n.height(i.sticky_nav.outerHeight()),
              n.insertAfter(i.sticky_nav),
              e("body").append(i.sticky_nav),
              i.sticky_nav.addClass("kingster-fixed-navigation"),
              setTimeout(function () {
            ...
            if (
              ...
              a.insertAfter(i.sticky_nav),
                ...
                i.sticky_nav.removeClass(
                  "kingster-fixed-navigation kingster-animate-fixed-navigation"
                ),
        ...
        if (
          ...
          if (i.mobile_menu.hasClass("kingster-fixed-navigation")) {
            if (
              ...
              a.insertAfter(i.mobile_menu),
                a.slideUp(200, function () {
                  e(this).remove();
                }),
                i.mobile_menu.insertBefore(n),
                n.remove(),
                i.mobile_menu.removeClass("kingster-fixed-navigation"),
                i.mobile_menu.css("display", "block");
            }
          } else
            e(window).scrollTop() + s >
              i.mobile_menu.offset().top + i.mobile_menu.outerHeight() + 200 &&
              (n.height(i.mobile_menu.outerHeight()).insertAfter(i.mobile_menu),
              e("body").append(i.mobile_menu),
              i.mobile_menu.addClass("kingster-fixed-navigation"),
  ...
  (r.prototype = {
    ...
    (e.fn.kingster_tab = function () {
      ...
      t.find(".gdlr-core-tab-item-title").on("click", function () {
        ...
        i.siblings(".gdlr-core-tab-item-content-image-wrap").each(function () {
          ...
          n.length
            ? (e(this).css("width", ""),
              e(this).css("height", i.outerHeight()),
              n.siblings().removeClass("gdlr-core-active"),
              n.addClass("gdlr-core-active"))
            : (e(this).css("width", "0px"),
              e(this).children().removeClass("gdlr-core-active"));
        });
      }),
        t
          .find(".gdlr-core-tab-item-content-image-wrap")
          .css(
            "height",
            e(this).find(".gdlr-core-tab-item-wrap").outerHeight()
          ),
        e(window).on("load resize", function () {
          t.find(".gdlr-core-tab-item-content-image-wrap").css(
            "height",
            t.find(".gdlr-core-tab-item-wrap").outerHeight()
          );
        });
    }),
    e(document).ready(function () {
      new r(),
        e(
          "#kingster-main-menu, #kingster-right-menu, #kingster-mobile-menu, #kingster-top-bar-menu"
        ).each(function () {
          e(this).hasClass("kingster-overlay-menu")
            ? new n(e(this))
            : e(this).hasClass("kingster-mm-menu-wrap")
            ? e(this).kingster_mobile_menu()
            : new i(e(this));
        }),
        e("#kingster-top-search, #kingster-mobile-top-search").each(
          function () {
        ...
        e("#kingster-main-menu-cart, #kingster-mobile-menu-cart").each(
          function () {
            e(this).on({
              mouseenter: function () {
        ...
        e(
          ".kingster-header-boxed-wrap, .kingster-header-background-transparent, .kingster-navigation-bar-wrap.kingster-style-transparent"
        ).each(function () {
          var t = e(this),
        ...
        e("body.error404, body.search-no-results").each(function () {
          var t = e(this).find("#kingster-full-no-header-wrap"),
            i = parseInt(
              e(this)
                .children(".kingster-body-outer-wrapper")
                .children(".kingster-body-wrapper")
                .css("margin-bottom")
            ),
      ...
      t.length &&
        e(window).on("scroll", function () {
          e(window).scrollTop() > 300
            ? t.addClass("kingster-scrolled")
            : t.removeClass("kingster-scrolled");
        }),
        e("body")
          .children("#kingster-page-preload")
          .each(function () {
            var t = e(this),
            ...
            e("a[href]")
              ...
              .on("click", function (n) {
                1 != n.which ||
                  e(this).hasClass("kingster-no-preload") ||
                  (window.location.href != this.href &&
                    t.addClass("kingster-out").fadeIn(i));
              }),
              e(window).load(function () {
                t.fadeOut(i);
              });
          }),
        e("body.kingster-blog-style-2 .kingster-single-nav-area").each(
          function () {
            var t,
              i = e(this).children();
            (t = 0),
    ...
    e(window).load(function () {
      e("#kingster-fixed-footer").each(function () {
        ...
        i.insertBefore(t),
          ...
          e("body").css(
            "min-height",
            e(window).height() - parseInt(e("html").css("margin-top"))
          ),
          e(window).resize(function () {
            i.height(t.outerHeight()),
              e("body").css(
        ...
        new s(e("#kingster-header-side-nav")),
        new o(),
        new a();
    });
})(jQuery),
    ...
    (e[a] && e[a].version > "5.6.1") ||
      ...
      (e[a].prototype = {
        ...
        openPanel: function (i) {
          ...
          if (n.hasClass(t.vertical)) {
            ...
            r
              ...
              .not("." + t.vertical)
              .addClass(t.hidden),
              e[a].support.csstransitions || l.addClass(t.hidden),
              i.hasClass(t.opened)
                ? i
                    .nextAll("." + t.opened)
                    .addClass(t.highest)
              ...
              s.trigger("openPanel", i),
              setTimeout(function () {
                i.removeClass(t.subopened).addClass(t.opened),
                  s.trigger("openingPanel", i),
                  s.__transitionend(
                    i,
                    function () {
        ...
        _initPanels: function (n) {
          ...
          this.__refactorClass(a, this.conf.classNames.inset, "inset").addClass(
            t.nolistview + " " + t.nopanel
          ),
            a.not("." + t.nolistview).addClass(t.listview);
          ...
          this.__refactorClass(l, this.conf.classNames.vertical, "vertical"),
            ...
            l.each(function () {
              ...
              var a = i.attr("id");
              i.removeAttr("id"),
                n.attr("id", a || s.__getUniqueId()),
                i.hasClass(t.vertical) &&
                  (i.removeClass(s.conf.classNames.vertical),
          ...
          r.each(function (n) {
            ...
            if (
              (l.is("." + t.panels) || (l.data(i.sub, r), r.data(i.parent, l)),
              ...
              !r.children("." + t.navbar).length && !l.hasClass(t.vertical))
            ) {
              l.parent().is("." + t.listview)
                ? (l = l.closest("." + t.panel))
                : (l = (c = l
              ...
              if (l.length) {
                ...
                d
                  ...
                  .prependTo(r),
                  s.opts.navbar.add && r.addClass(t.hasnavbar);
              } else
                s.opts.navbar.title &&
                  (d
                    .append(
        ...
        _initAnchors: function () {
          ...
          s.$body.on(n.click + "-oncanvas", "a[href]", function (n) {
            ...
            var c = s.attr("href");
            if (!o && r && c.length > 1 && "#" == c.slice(0, 1))
              try {
                var d = e(c, i.$menu);
                d.is("." + t.panel) &&
                  ((o = !0),
                  i[
                    s.parent().hasClass(t.vertical)
                      ? "togglePanel"
                      : "openPanel"
                  ](d));
              } catch (e) {}
            if (
              ...
              !o &&
                r &&
                s.is("." + t.listview + " > li > a") &&
                !s.is('[rel="external"]') &&
                !s.is('[target="_blank"]'))
            ) {
              i.__valueOrFn(i.opts.onClick.setSelected, s) &&
              ...
              h && n.preventDefault(),
                i.__valueOrFn(i.opts.onClick.close, s, h) && i.close();
            }
          });
        },
        _initAddons: function () {
          var t;
          for (t in e[a].addons)
            e[a].addons[t].add.call(this),
              (e[a].addons[t].add = function () {});
        ...
        __transitionend: function (e, t, i) {
          ...
          e.one(n.transitionend, a),
            e.one(n.webkitTransitionEnd, a),
            setTimeout(a, 1.1 * i);
        },
      ...
      (e.fn[a] = function (o, r) {
        return (
          e[a].glbl ||
            ...
            (e[a]._e = n),
            (e[a].glbl = s)),
          (o = e.extend(!0, {}, e[a].defaults, o)),
          (r = e.extend(!0, {}, e[a].configuration, r)),
          this.each(function () {
            var t = e(this);
            if (!t.data(a)) {
              var i = new e[a](t, o, r);
    ...
    (e[a].addons[o] = {
      setup: function () {
        if (this.opts[o]) {
          ...
          (s = e[a].glbl),
            ...
            (s.$allMenus = (s.$allMenus || e()).add(this.$menu)),
            (this.vars.opened = !1);
          var r = [t.offcanvas];
          "left" != i.position && r.push(t.mm(i.position)),
            "back" != i.zposition && r.push(t.mm(i.zposition)),
            this.$menu.addClass(r.join(" ")).parent().removeClass(t.wrapper),
            this.setPage(s.$page),
            this._initBlocker(),
            this["_initWindow_" + o](),
      ...
      clickAnchor: function (e, t) {
        ...
        return i && e.is('[href="#' + i + '"]')
          ...
          : s.$page
          ? !(
              !(i = s.$page.first().attr("id")) || !e.is('[href="#' + i + '"]')
            ) && (this.close(), !0)
          : void 0;
      },
    }),
      ...
      (e[a].prototype._openSetup = function () {
        ...
        var l = [t.opened];
        r.blockUI && l.push(t.blocking),
          "modal" == r.blockUI && l.push(t.modal),
          r.moveBackground && l.push(t.background),
          "left" != r.position && l.push(t.mm(this.opts[o].position)),
          "back" != r.zposition && l.push(t.mm(this.opts[o].zposition)),
          this.opts.extensions && l.push(this.opts.extensions),
          s.$html.addClass(l.join(" ")),
          setTimeout(function () {
            a.vars.opened = !0;
          }, this.conf.openingInterval),
          ...
          this.__transitionend(
            ...
            function () {
              n.$menu.removeClass(t.current).removeClass(t.opened),
                ...
                n.opts.extensions && s.$html.removeClass(n.opts.extensions),
                s.$page.each(function () {
      ...
      (e[a].prototype.setPage = function (i) {
        var n = this,
          a = this.conf[o];
        (i && i.length) ||
          ((i = s.$body.find(a.pageSelector)),
          a.noPageSelector.length && (i = i.not(a.noPageSelector.join(", "))),
          i.length > 1 &&
            a.wrapPageIfNeeded &&
      ...
      (e[a].prototype["_initWindow_" + o] = function () {
        s.$wndw.off(n.keydown + "-" + o).on(n.keydown + "-" + o, function (e) {
          return s.$html.hasClass(t.opened) && 9 == e.keyCode
            ? (e.preventDefault(), !1)
            : void 0;
        });
        var e = 0;
          ...
          s.$blck
            ...
            .on(
              ...
              function (e) {
                e.preventDefault(),
                  e.stopPropagation(),
                  s.$blck.trigger(n.mousedown + "-" + o);
              }
            )
            .off(n.mousedown + "-" + o)
            .on(n.mousedown + "-" + o, function (e) {
              e.preventDefault(),
                s.$html.hasClass(t.modal) || (i.closeAllOthers(), i.close());
            }));
      });
  })(jQuery),
  (function (e) {
      ...
      setup: function () {
        ...
        if (
          ...
          e[s].support.touch &&
            ...
            "object" != typeof r && (r = {}),
            (r = this.opts[a] = e.extend(!0, {}, e[s].defaults[a], r)).fix))
        ) {
        ...
        (v = function (t) {
          (t.retainPath = e.inArray(this[0], t.$path) > -1),
            ...
            this.parents("." + t.hoverClass).length ||
              (t.onIdle.call(_(this)), t.$path.length && e.proxy(m, t.$path)());
        }),
        (_ = function (e) {
          return e.closest("." + a);
        }),
        ...
        }),
        {
          ...
          init: function (t) {
            return this.each(function () {
              ...
              var n,
                a = e.extend({}, e.fn.superfish.defaults, t),
              ...
              (a.$path =
                ...
                (function (t, i) {
                  ...
                  e.fn.hoverIntent && !i.disableHI
                    ? t.hoverIntent(m, g, n)
                    : t
                        .on("mouseenter.superfish", n, m)
                        .on("mouseleave.superfish", n, g);
                  var s = "MSPointerDown.superfish";
                  d && (s = "pointerdown.superfish"),
                    l || (s += " touchend.superfish"),
                    c && (s += " mousedown.superfish"),
                    t
